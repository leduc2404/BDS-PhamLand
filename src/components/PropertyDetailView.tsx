            ...
            <aside className="lg:col-span-4">
              <div className="sticky top-28 bg-[#0a1128] rounded-sm p-6 sm:p-8 relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] ring-1 ring-white/10">
                ...
                <div className="relative z-10">
                  ...
                  <SidebarContactForm propertyTitle={fp.title} propertyPrice={fp.priceDisplay || `${(fp.price / 1_000_000_000).toFixed(1)} Tỷ`} propertyUrl={`https://www.bdsphamland.com/du-an/${fp.slug || fp.id}`} />
                </div>
              </div>
            </aside>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <aside className="lg:col-span-4">
            <div className="sticky top-28 bg-[#0a1128] rounded-sm p-6 sm:p-8 relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] ring-1 ring-white/10">
              ...
              <div className="relative z-10">
                <h3 className="text-sm font-serif font-medium text-white mb-6 text-center">Đăng ký nhận quỹ căn độc quyền</h3>
                  <SidebarContactForm propertyTitle={p.title} propertyPrice={p.price} propertyUrl={`https://www.bdsphamland.com/du-an/${p.id}`} />
              </div>
            </div>
          </aside>
        </div>
